...
public class    FlavorActivity extends AppCompatActivity
{
    ...
    public void updateView() {
        ArrayList<Item> flavors = itemManager.selectFlavors();
        ...
        group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                Intent toppingIntent = new Intent(
                        thisActivity, ToppingActivity.class );
                thisActivity.startActivity( toppingIntent );
                // confirm to the user
                Toast.makeText(FlavorActivity.this, selected.getName(), Toast.LENGTH_SHORT).show();
        ...
        relativeLayout.setBackgroundColor(getResources().getColor(R.color.colorPurple));
